...
export default function Options({styles}) {
  ...
  return (
    <div>
        <div class={`h-6 w-6 dark:bg-slate-800 absolute origin-bottom-left  rotate-45 transform  bg-white ${styles}`}></div>
      <div className="bg-white dark:bg-slate-800 h-40 w-44 rounded-lg">
        {/*  options */}
