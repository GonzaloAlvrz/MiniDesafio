...
export default function Slider() {
  ...
  return (
    <div className="w-full h-[650px]  mx-auto relative mobile:mt-28  tablet:mt-20 desktop-one:mt-0 desktop-two:mt-0">
      ...
      ></div>
      <div onClick={prevSlide} className="absolute top-[70%] translate-x-0 translate-y-[-50%] right-60 text-2xl laptop:flex laptop:justify-center laptop:items-center h-11 w-11 rounded-full p-2 bg-white text-white cursor-pointer z-10 mobile:hidden laptop:block">
        <img src={ArrowL}  alt="" />
      </div>
      <div  onClick={nextSlide} className="absolute top-[70%] translate-x-0 translate-y-[-50%] right-40 text-2xl laptop:flex laptop:justify-center laptop:items-center h-11 w-11 rounded-full p-2 bg-white text-white cursor-pointer z-10 mobile:hidden laptop:block">
        <img src={ArrowR} alt="" />
      </div>
