...
export default function Register({ setSignUp }) {
  ...
  return (
    <div className="w-full h-screen relative bottom-[126px] bg-slate-50/50">
      <div className="bg-gray-300 mx-auto mobile:w-[370px] mobileL:w-[450px] h-[600px] relative mobile:top-10 desktop-two:top-32 flex flex-col">
        ...
        <div className="mx-auto w-full">
          <form className="flex flex-col " onSubmit={handleSubmit}>
            ...
            <div className="flex flex-row">
              ...
              />
              <p className="pr-9 text-justify w-[350px]">
                DC y sus afiliados de WarnerMedia pueden usar mi dirección de
                correo electrónico para enviar actualizaciones , anuncios y
                ofertas.
              </p>
            </div>
            <div className="flex flex-row my-4 ">
              ...
              />
              <p className="pr-4 text-justify">Aceptos los Términos de uso.</p>
            </div>
            <button
              type="submit"
