...
export default function Slider() {
  ...
  return (
    <div className="w-full h-[650px]  mx-auto py-16 relative mobile:mt-28  tablet:mt-20 desktop-one:mt-0 desktop-two:mt-44">
      ...
      <div
        onClick={prevSlide}
        className="absolute top-[50%] translate-x-0 translate-y-[-50%] left-10 text-2xl flex justify-center items-center h-11 w-11 rounded-full p-2 bg-white text-white cursor-pointer z-10"
      >
        <img src={ArrowL} alt="" />
      </div>
      {/* right button */}
      <div
        onClick={nextSlide}
        className="absolute top-[50%] translate-x-0 translate-y-[-50%] right-10 text-2xl flex justify-center items-center h-11 w-11 rounded-full p-2 bg-white text-white cursor-pointer z-10"
      >
        <img src={ArrowR} alt="" />
      </div>
      {/* information */}
      <div className="absolute  top-[50%] translate-x-0 translate-y-[-50%]  mobile:w-full mobile:   laptop:w-96  laptop:left-40 text-white ">
        ...
        <div
          onClick={click}
          className="mobile:flex mobile:justify-center laptop:justify-start"
        >
